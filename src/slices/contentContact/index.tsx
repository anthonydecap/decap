...
/**
 * Props for `ContentContact`.
 */
type ContentContactProps = SliceComponentProps<any>;

/**
 * Component for "ContentContact" Slices.
 */
const ContentContact: FC<ContentContactProps> = ({ slice }) => {
